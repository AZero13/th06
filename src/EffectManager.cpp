...
__declspec(allocate(".data$D1g_EffectManager")) DIFFABLE_STATIC(EffectManager, g_EffectManager);
__declspec(allocate(".data$D2g_EffectManagerCalcChain")) DIFFABLE_STATIC(ChainElem, g_EffectManagerCalcChain);
__declspec(allocate(".data$D3g_EffectManagerDrawChain")) DIFFABLE_STATIC(ChainElem, g_EffectManagerDrawChain);
