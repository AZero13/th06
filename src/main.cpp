...
__declspec(allocate(".data$L1g_GameWindow"))
DIFFABLE_STATIC(GameWindow, g_GameWindow);
__declspec(allocate(".data$L2g_TickCountToEffectiveFramerate"))
DIFFABLE_STATIC(i32, g_TickCountToEffectiveFramerate);
__declspec(allocate(".data$L3g_LastFrameTime"))
DIFFABLE_STATIC(f64, g_LastFrameTime);
__declspec(allocate(".data$L4g_ExclusiveMutex"))
